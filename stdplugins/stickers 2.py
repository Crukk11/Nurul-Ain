...
async def _(event):
    ...
    me = borg.me
    userid = borg.uid
    packname = f"Nasi Kandaq Kang Pack"
    packshortname = f"Id_731950853_p1"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"Animated Pack by M.Nasir"
        packshortname = f"Id_731950853_as"  # format: Uni_Borg_userid
